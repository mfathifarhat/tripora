    ...
    <Layout>
      ...
      <section className="hero-section relative w-full overflow-hidden" id="heroSection">
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4" style={{ paddingTop: 'clamp(6rem, 18vh, 9rem)' }}>
          ...
          <h1 className="font-extrabold leading-[1.05] text-4xl sm:text-5xl md:text-7xl drop-shadow-[0_4px_24px_rgba(0,0,0,0.35)] transition-all duration-700 bg-gradient-to-r from-white via-blue-200/80 to-white bg-clip-text text-transparent" id="slideTitle">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-start">
              ...
              <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-xl shadow-slate-900/5 flex flex-col">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                  <button className="bg-blue-500 hover:bg-blue-600 text-white transition rounded-full px-5 py-2.5 text-sm font-semibold shadow-lg shadow-blue-500/30">
      ...
      <section className="relative z-10 overflow-hidden bg-[#f4f5f8] py-20 sm:py-24 px-4 sm:px-8 md:px-12 text-slate-900">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 mb-8 sm:mb-10">
            <img className="tool-icon" src="/images/excel.png" alt="Spreadsheet" style={{ animationDelay: '0s', ['--ty' as any]: '6px' }} />
            <img className="tool-icon" src="/images/notes.png" alt="Notes" style={{ animationDelay: '0.3s', ['--ty' as any]: '-8px' }} />
            <img className="tool-icon" src="/images/google-maps.png" alt="Maps" style={{ animationDelay: '0.6s', ['--ty' as any]: '4px' }} />
            <img className="tool-icon" src="/images/traveloka.png" alt="Booking App" style={{ animationDelay: '0.9s', ['--ty' as any]: '-6px' }} />
          </div>

          {/* Tool icons - bottom row */}
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
            <img className="tool-icon" src="/images/notion.png" alt="Notion" style={{ animationDelay: '0.2s', ['--ty' as any]: '-4px' }} />
            <img className="tool-icon" src="/images/docs.png" alt="Docs" style={{ animationDelay: '0.5s', ['--ty' as any]: '8px' }} />
            <img className="tool-icon" src="/images/triplor.png" alt="Airbnb" style={{ animationDelay: '0.8s', ['--ty' as any]: '-6px' }} />
            <img className="tool-icon" src="/images/email.png" alt="Email" style={{ animationDelay: '1.1s', ['--ty' as any]: '6px' }} />
            <img className="tool-icon" src="/images/chatgpt.png" alt="ChatGPT" style={{ animationDelay: '1.4s', ['--ty' as any]: '-4px' }} />
          </div>
